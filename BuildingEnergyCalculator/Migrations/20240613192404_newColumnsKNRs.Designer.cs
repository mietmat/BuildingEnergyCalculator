...
namespace BuildingEnergyCalculator.Migrations
{
    ...
    [Migration("20240613192404_newColumnsKNRs")]
    partial class newColumnsKNRs
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BuildingEnergyCalculator.Entities.Library.KNR", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("KNRName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("KNRNo")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("BuildingEnergyCalculator.Entities.Library.KNRMachine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("KNRMachine");
                });

            modelBuilder.Entity("BuildingEnergyCalculator.Entities.Library.KNRMaterial", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("KNRMaterial");
                });

            modelBuilder.Entity("BuildingEnergyCalculator.Entities.Library.Labor", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BuildingEnergyCalculator.Entities.Library.Occupation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BuildingEnergyCalculator.Entities.Library.KNRMachine", b =>
                {
                    b.HasOne("BuildingEnergyCalculator.Entities.Library.KNR", null)
                        .WithMany("MachineList")
                        .HasForeignKey("KNRId");
                });
            ...
            modelBuilder.Entity("BuildingEnergyCalculator.Entities.Library.KNR", b =>
                {
                    b.Navigation("LaborList");

                    b.Navigation("MachineList");

                    b.Navigation("MaterialList");

                    b.Navigation("OccupationList");
                });
